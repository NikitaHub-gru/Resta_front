							...
							<div className='relative rounded-md border bg-background'>
								<ScrollArea className='h-[200px] w-full overflow-hidden'>
									<textarea
										...
										className='h-full w-full resize-none bg-transparent p-4 font-mono text-sm leading-relaxed text-foreground outline-none dark:text-[#d4d4d4]'
										style={{
											fontFamily:
