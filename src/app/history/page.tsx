  ...
  return (
    <div className="h-screen w-screen bg-[#171717]">
      <SidebarDemo>
        <Dashboard>
          <div className="h-full w-full p-4">
            <Card className="h-full bg-[#171717]">
              <CardHeader>
                ...
                <div className="w-[250px] mt-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      {[...new Set(rawData.map((item) => item.reportId))].map(
                        (id) => (
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b">
                          <th className="text-left p-4">ID отчета</th>
                          <th className="text-left p-4">Дата начала</th>
                          <th className="text-left p-4">Дата окончания</th>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent className="bg-[#171717]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Вы уверены, что хотите удалить этот отчет? После удаления данный
              отчет нельзя будет восстановить.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <Dialog open={viewModalOpen} onOpenChange={setViewModalOpen}>
        <DialogContent className="top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[90vw] h-[80vh] p-0 bg-[#171717] fixed flex flex-col">
          <div className="sticky top-0 z-50 bg-[#171717] border-b border-gray-700">
                    ...
                    <thead>
                      <tr className="border-b border-gray-700">
                        {COLUMN_ORDER.map((columnName) => (
                          <th
                            key={columnName}
                            className="text-left p-4 font-semibold text-sm whitespace-nowrap bg-[#1f1f1f] sticky top-0"
                          >
                            {columnName}
                          </th>
                        ))}
